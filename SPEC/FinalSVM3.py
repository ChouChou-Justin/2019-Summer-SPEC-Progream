...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\trainingData_3.csv', 'r') as f:
    reader = csv.reader(f)
    Dataset = list(reader)
...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\validationData_3.csv', 'r') as f:
    reader = csv.reader(f)
...
accuracy3 = (512-accuracycounter)/512
