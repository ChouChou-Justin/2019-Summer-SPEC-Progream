...
import FinalSVM2 as FSVM2
import FinalSVM3 as FSVM3
import FinalSVM1 as FSVM1
...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\trainingData_0.csv', 'r') as f:
    reader = csv.reader(f)
    Dataset = list(reader)
...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\validationData_0.csv', 'r') as f:
    reader = csv.reader(f)
...
accuracy0 = (512-accuracycounter)/512
accuracy1 = FSVM1.accuracy1
accuracy2 = FSVM2.accuracy2
accuracy3 = FSVM3.accuracy3
averageAccuracy = (accuracy0 + accuracy1 + accuracy2 + accuracy3)/4
