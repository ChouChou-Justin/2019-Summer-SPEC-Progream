...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\trainingData_1.csv', 'r') as f:
    reader = csv.reader(f)
    Dataset = list(reader)
...
with open('C:\\Users\\Justin\\Desktop\\SPEC Final Project\\validationData_1.csv', 'r') as f:
    reader = csv.reader(f)
...
accuracy1 = (512-accuracycounter)/512
